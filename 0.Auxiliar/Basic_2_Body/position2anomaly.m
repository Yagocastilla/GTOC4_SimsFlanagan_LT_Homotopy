...
%{
###########################################################################
                      Position and Velocity to Anomaly
                        Author:  Yago Castilla Lamas
###########################################################################

This function allows the computation of different anomalies of an orbit
based on the position and velocity of the object. The algorithm is prepared
for both elliptic and hyperbolic orbits.
