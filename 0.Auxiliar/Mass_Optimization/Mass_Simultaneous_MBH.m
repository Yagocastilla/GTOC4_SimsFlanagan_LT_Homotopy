function impulses = Mass_Simultaneous_MBH(r_ini,v_ini,r_obj,req_v_fin,ToFs, ...
                                           initMass,init_guess,n_i,T_limit,pars,kmax,rho,max_rep)
...
opt_results = MBH(penalObj,constraint,T_0,-bounds,bounds,kmax,rho,max_rep);
